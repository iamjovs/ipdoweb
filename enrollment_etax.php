...
<title>Enrollment E-Tax Report | Intitutional Planning and Development Office</title>
...
?>
   <main id="main" class="main">
    <div class="row">
      <div class="pagetitle ">
        <h1> <strong>Enrollment E-Tax</strong></h1>
      </div>
      <nav>
        <ol class="breadcrumb">
          
          <li class="breadcrumb-item active">Enrollment E-TaxT Report</li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><strong>Add Enrollment E-Tax Data</strong></h5>
            ...
            <div class="modal-body">
                ...
                <h6 class="modal-title"><strong>Enrollment E-Tax</strong></h6>
                <div class="col-md-12">
