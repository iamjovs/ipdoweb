...
<title>Memorandom of Agreement Report | Intitutional Planning and Development Office</title>
...
?>
   <main id="main" class="main">
    <div class="row">
      <div class="pagetitle ">
        <h1> <strong>Memorandom of Agreement</strong></h1>
      </div>
      <nav>
        <ol class="breadcrumb">
          
          <li class="breadcrumb-item active">Memorandom of Agreement Report</li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><strong>Add Memorandom of Agreement Data</strong></h5>
            ...
            <div class="modal-body">
                ...
                <h6 class="modal-title"><strong>Memorandom of Agreement</strong></h6>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Number of Memorandom of Agreements</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Number of Memorandom of Understanding</label>
                  </div>
                </div>
