...
<title>Curricular Programs Report | Intitutional Planning and Development Office</title>
...
?>
   <main id="main" class="main">
    <div class="row">
      <div class="pagetitle ">
        <h1> <strong>Curricular Programs Programs</strong></h1>
      </div>
      <nav>
        <ol class="breadcrumb">
          
          <li class="breadcrumb-item active">Curricular Programs Report</li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><strong>Add Curricular Programs Data</strong></h5>
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                  <div class="form-floating ">
                    ...
                    <label for="floatingName">Advanced Education Courses</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Baccalaureate Courses</label>
                  </div>
