...
<title>AACCUP Accredited Programs Report | Intitutional Planning and Development Office</title>
...
?>
   <main id="main" class="main">
    <div class="row">
      <div class="pagetitle ">
        <h1> <strong>AACCUP Accredited Programs</strong></h1>
      </div>
      <nav>
        <ol class="breadcrumb">
          
          <li class="breadcrumb-item active">AACCUP Accredited Programs Report</li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><strong>Add AACCUP Accredited Programs Data</strong></h5>
            ...
            <div class="modal-body">
                ...
                <h6 class="modal-title"><strong>Number of AACCUP Accredited Programs</strong></h6>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Level III Re-Accredited</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Level II Re-Accredited</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Level I Accredited</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Candidate Status</label>
                  </div>
                </div>
