...
<title>Scholarships-StudentAssistant-OJT Report | Intitutional Planning and Development Office</title>
...
?>
   <main id="main" class="main">
    <div class="row">
      <div class="pagetitle ">
        <h1> <strong>Scholarships-StudentAssistant-OJT</strong></h1>
      </div>
      <nav>
        <ol class="breadcrumb">
          
          <li class="breadcrumb-item active">Scholarships-StudentAssistant-OJT Report</li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><strong>Add Scholarships-StudentAssistant-OJT Data</strong></h5>
            ...
            <div class="modal-body">
                ...
                <h6 class="modal-title"><strong>Scholarship</strong></h6>
                <div class="col-md-12">
                  <div class="form-floating ">
                    <input type="number" class="form-control" id="tp_jo" name="tp_jo" placeholder="Teaching Personel (JO)">
                    <label for="floatingName">Number of Scholarships Grantess (Student)</label>
                  </div>
                </div>
                <h6 class="modal-title"><strong>Student Assistants</strong></h6>
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="ntp_pl" name="ntp_pl" placeholder="Non-Teaching Personel (Plantilla)">
                    <label for="floatingName">Number of Students Assistants</label>
                  </div>
                </div>
                <h6 class="modal-title"><strong>On-The-Job Training</strong></h6>
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="cjo" name="cjo" placeholder="Job Order & Casual">
                    <label for="floatingName">Number of OJT (Local)</label>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="cjo" name="cjo" placeholder="Job Order & Casual">
                    <label for="floatingName">Number of OJT (Abroad)</label>
                  </div>
                </div>
